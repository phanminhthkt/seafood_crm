          ...
          <div class="tab-content">
              <div class="tab-pane fade active show" id="vi">
                <div class="form-group">
                  <label>Quyền</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="name" name="name" placeholder="Quyền" value="{{$item->name}}" required="">
                ...
                <div class="form-group">
                  <label>Module</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="module2" name="module" placeholder="Module" value="{{$item->module}}" required="">
                ...
                <div class="form-group">
                  <label>Hành động</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="action" name="action" placeholder="Hành động" value="{{$item->action}}" required="">
                ...
                <div class="form-group">
                  <label>Kiểu</label>
                    <div class="input-group">
                      <input type="text" class="form-control" id="type" name="type" placeholder="Kiểu" value="{{$item->type}}">
                      <div class="invalid-feedback">Vui lòng nhập hành động(Ex:view,create,edit,...)</div>
                    </div>
                </div>
