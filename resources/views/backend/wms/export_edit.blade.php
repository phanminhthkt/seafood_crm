        ...
        <div class="row mt-3">
          <div class="col-sm-6">
            <div class="form-group">
              <label>Ghi chú</label>
              <div class="input-group input-group--custom">
                <textarea name="note" class="form-control"  id="note"  rows="4">{{$item->note}}</textarea>
              </div>
            </div>
            @if($item->status_id !== 2)
          ...
          <div class="col-sm-6">
            <div class="form-group row">
              ...
              <div class="col-7 text-danger text-right">
                  <div class="input-group input-group--custom">
                  <input type="text" data-toggle="input-mask" data-mask-format="000,000,000,000" data-reverse="true" class="form-control text-right" id="ship_price" name="ship_price" placeholder="0" value="{{number_format($item->ship_price, 0,'',',')}}"> <span class='mt-1 text-muted'>đ</span>
                </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-7 text-danger text-right">
                <div class="input-group input-group--custom">
                  <input type="text" data-toggle="input-mask" data-mask-format="000,000,000,000" data-reverse="true" class="form-control text-right" id="reduce_price" name="reduce_price" placeholder="0" value="{{number_format($item->reduce_price, 0,'',',')}}"> <span class='mt-1 text-muted'>đ</span>
                </div>
              </div>
            </div>
            <div class="form-group row">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input 
                ...
                value="{{formatDate($item->export_created_at,'d-m-Y H:i')}}" 
                readonly="readonly"
