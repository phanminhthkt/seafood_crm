...
<div class="row d-flex row-wms">
  ...
  <div class="col-lg-8">
    ...
    @can('re-update-wms-import')
    <button type="button" onclick="window.location='{{route('admin.wms.import.edit', ['id' => $item->id])}}'" value="1" class="hidden-xs btn btn-info waves-effect waves-light">Sửa phiếu</button>
    @endcan
  ...
  <div class="col-lg-4">
    <div class="card">
      ...
      <div class="card-body">
          ...
          <div class="form-group mb-1 row">
              ...
              <div class="col-7 text-purple text-right"><b class="medium">{{formatDate($item->import_created_at,'d/m/Y H:i')}}</b></div>
          </div>
          <div class="form-group mb-1 row">
    ...
    @can('re-update-wms-import')
    <button type="button" onclick="window.location='{{route('admin.wms.import.edit', ['id' => $item->id])}}'" value="1" class="hidden-sm btn btn-info waves-effect waves-light">Sửa phiếu</button>
    @endcan
